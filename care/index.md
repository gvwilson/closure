...
<p class="subtitle">the most important part</p>
...
-   Dame Cicely Saunders, who founded the modern hospice movement,
    introduced the concept of [%g total-pain "total pain" %]
    to describe how a dying patient's suffering is never purely physical [%b Saunders1963 %]
...
-   [%b Hobfoll2007 %] identified five principles
...
-   [%b Rando2000 %] studied [%g anticipatory-mourning "anticipatory mourning" %]:
    ...
    -   It involves simultaneous processing of past losses (what the project once was),
        present losses (what it is becoming), and future losses (what it will never be)
...
-   [%b Shepherd2003 Shepherd2016 %] found that the intensity of grief after a failed venture
